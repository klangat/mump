...
INSERT INTO `accounts_emailactivation` VALUES (1,'jobmakori94@gmail.com','gtzmzh4f5byzdk1x8blexejxdocnu7',1,0,7,'2019-03-15 19:46:51.632955','2019-03-15 19:47:27.710726',1);
...
INSERT INTO `accounts_user` VALUES (1,'pbkdf2_sha256$120000$DGB61rR3zVqb$BFLXLv9OiZDGsAaq9Rxgum6KpFfGfRCBCutEO+PDHHs=','2019-03-15 20:07:24.793435','jobmakori94@gmail.com','','',31762522,1,1,1,'2019-03-15 19:46:51.515583');
...
CREATE TABLE `orders_order` (
  ...
  `residence_total` decimal(50,2) NOT NULL,
  `total` decimal(50,2) NOT NULL,
  `active` tinyint(1) NOT NULL,
  `updated` datetime(6) NOT NULL,
  `timestamp` datetime(6) NOT NULL,
  ...
  `cart_id` int(11) NOT NULL,
  `personal_pick_id` int(11) DEFAULT NULL,
  ...
  KEY `orders_order_personal_pick_id_4fcedf30_fk_addresses_address_id` (`personal_pick_id`),
  KEY `orders_order_residence_id_93cc5545_fk_addresses_address_id` (`residence_id`),
  ...
  CONSTRAINT `orders_order_personal_pick_id_4fcedf30_fk_addresses_address_id` FOREIGN KEY (`personal_pick_id`) REFERENCES `addresses_address` (`id`),
  CONSTRAINT `orders_order_residence_id_93cc5545_fk_addresses_address_id` FOREIGN KEY (`residence_id`) REFERENCES `addresses_address` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
