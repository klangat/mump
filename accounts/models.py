...
from ecommerce.utils import random_string_generator, unique_key_generator,unique_slug_generator
...
class EmailActivation(models.Model):
    ...
    def send_activation(self):
        if not self.activated and not self.forced_expired:
            if self.key:
                base_url = getattr(settings, 'BASE_URL', 'https://www.moimarketplace.com:8000')
